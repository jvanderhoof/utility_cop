...
RSpec.describe "app_environment_credentials/new", type: :view do
  before(:each) do
    assign(:app_environment_credential, AppEnvironmentCredential.new(
      :credential_id => 1,
  ...
  it "renders new app_environment_credential form" do
    render

    assert_select "form[action=?][method=?]", app_environment_credentials_path, "post" do
